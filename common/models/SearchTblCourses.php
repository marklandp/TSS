...
/**
 * SearchTblCourses represents the model behind the search form about `common\models\TblCourses`.
 */
class SearchTblCourses extends TblCourses
{
    /**
     * @inheritdoc
     */
