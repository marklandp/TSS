...
/**
 * SearchTblAssestTest represents the model behind the search form about `common\models\TblAssestTest`.
 */
class SearchTblAssestTest extends TblAssestTest
{
    /**
     * @inheritdoc
     */
